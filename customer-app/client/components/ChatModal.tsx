...
const ChatModal: React.FC<ChatModalProps> = ({ isOpen, onClose, orderId, cookName }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      await sendChatMessage(orderId, message.trim(), 'customer');
      setMessage('');
    } catch (error) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4 max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Chat with {cookName}</h3>
